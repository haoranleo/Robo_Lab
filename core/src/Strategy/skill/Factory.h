...
namespace PlayerRole{
	...
	CPlayerTask* makeItInterKickV3(const int num, const double dir,const int flags);
	...
	CPlayerTask* makeItGoAndTurnKick(const int num ,const double targetdir,const double kickprecision = Param::Math::PI*5/180,const int flags = 0);
	...
	CPlayerTask* makeItMarkEnemy(const int num,const int priority,const bool front = false,const int flags = 0,const CGeoPoint pos = CGeoPoint(1000,1000));
