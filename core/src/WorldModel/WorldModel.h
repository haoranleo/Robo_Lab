...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	//Conditions:
	bool isPointInArea(const CGeoPoint p,const CGeoPoint leftUp,const CGeoPoint rightDown);
	bool isInImmortalArea(const CGeoPoint p);
	bool isBallInLeftField();
	bool isInCorRushArea(const CGeoPoint p);
	bool isInMidRushArea(const CGeoPoint p);
